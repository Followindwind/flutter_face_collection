...
class DetectionCamera extends StatefulWidget{
  const DetectionCamera({Key? key}) : super(key: key);

  @override
  State<DetectionCamera> createState() => _DetectionCameraState();
}
    ...
    return Stack(
        children: [
          ...
          Positioned(
              ...
              child:
              mIsDetectSuccess?
              Image.asset("assets/images/face_v3_success.png",
                  fit: BoxFit.scaleDown,
                  width: faceFrameWidth,
                  height: faceFrameHeight)
                  :
              Image.asset("assets/images/face_v3_normal.png",
                  fit: BoxFit.scaleDown,
                  width: faceFrameWidth,
                  height: faceFrameHeight)
          ),
